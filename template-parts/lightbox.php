...
<div id="custom-lightbox">
    ...
    <div class="navigation">
        <span class="prev_span">
            <img class="prev" src="<?php echo get_template_directory_uri(); ?>/assets/images/short-arrow-left.png" alt="fleche_gauche"> 
            Précédente
        </span>
        <span class="next_span">
            Suivante
            <img class="next" src="<?php echo get_template_directory_uri(); ?>/assets/images/short-arrow-right.png" alt="fleche_droite">
        </span>
    </div>
</div>